...
public class WeaponSpec
{
    ...
    private static readonly Dictionary<short, WeaponSpec> SpeckMapper = new Dictionary<short, WeaponSpec>()
    {
        ...
        { 6, new WeaponSpec(){ WeaponName = "MAC10", FirePower = 40f, FiringInterval = 0.055f, BulletSpeed = 60f, MagazineSize = 30, ReloadTime = 1.5f, AccuracyMin = 0.3f, AccuracyMax = 10f, FullAuto = true, Holding = HoldingMethod.Pistol, ModelName = "mac10", FireAudio = "fire1", ChangeFireModeWeapon = 0, BulletCount = 1, BulletName = "BulletPrefab", BulletInstanceOffset = 0f, Scope = ZoomModeEnum.None, HandlingPosition = new Vector3(0, 0.0115f, -0.0103f), MuzzlePosition = new Vector3(0, 0.061f, 0.1021f), IsGrenade = false }},
